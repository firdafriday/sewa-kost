<?php 
	...
	class Transaksi extends CI_Controller{
		public function index(){
			...
			$data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, kos mb, customer cs WHERE tr.id_kos=mb.id_kos AND tr.id_customer=cs.id_customer AND cs.id_customer='$customer' ORDER BY id_rental ASC")->result();
		...
		public function pembayaran($id){
			$data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, kos mb, customer cs WHERE tr.id_kos=mb.id_kos AND tr.id_rental='$id' AND cs.nama_rental = tr.nama_rental ORDER BY id_rental DESC")->result();
		...
		public function cetak_invoice($id){
			$data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, kos mb, customer cs WHERE tr.id_kos=mb.id_kos AND tr.id_customer=cs.id_customer AND tr.id_rental='$id'")->result();
