<div class="main-content">
	...
	<?php foreach ($transaksi as $tr ) : ?>
		<form method="POST" action="<?php echo base_url('admin/transaksi/transaksi_selesai_aksi') ?>">
			...
			<input type="hidden" name="id_kos" value="<?php echo $tr->id_kos ?>">
			...
			<div class="form-group">
				...
				<select name="status_pengembalian" class="form-control">
					...
					<option value="Kembali">Kosong</option>
					<option value="Belum Kembali">Belum Kosong</option>
				</select>
			</div>
