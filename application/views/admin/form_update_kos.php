    ...
    <section class="section">
        ...
        <div class="card">
        	<div class="card-body">
        		...
        		<form method="POST" action="<?php echo base_url('admin/data_kos/update_kos_aksi') ?>" enctype="multipart/form-data">
        		<div class="row">
        			<div class="col-md-6">
        				<div class="form-group">
        					<label>Type Kos</label>
        					<input type="hidden" name="id_kos" value="<?php echo $mb->id_kos ?>">
