                    ...
                    <?php foreach ($transaksi as $tr) : ?>
                      <li class="media">
                        <div class="media-body">
                          <div class="float-right text-primary">Sewa #<?php echo $tr->id_rental ?></div>
                          <div class="media-title"><?php echo $tr->nama ?></div>
                          <span class="text-small text-muted text-bold">Sewa Kost <?php echo $tr->merk ?> dari tanggal <?php echo date('d/m/Y', strtotime($tr->tanggal_rental ))?> sampai <?php echo date('d/m/Y', strtotime($tr->tanggal_kembali ))?>.</span><br>
