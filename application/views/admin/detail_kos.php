                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <a class="btn btn-sm btn-danger ml-4" href="<?php echo base_url('admin/data_kos') ?>">Kembali</a>
                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/data_kos/update_kos/') . $dt->id_kos ?>">Update</a>
                        </div>
