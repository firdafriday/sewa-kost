                    ...
                    <?php foreach ($transaksi as $tr) : ?>
                      <li class="media">
                        <div class="media-body">
                          ...
                          <span class="text-small text-muted text-bold">Sewa kos <?php echo $tr->merk ?> dari tanggal <?php echo date('d/m/Y', strtotime($tr->tanggal_rental ))?> sampai <?php echo date('d/m/Y', strtotime($tr->tanggal_kembali ))?>.</span><br>
