							...
							<tr>
								...
								<td>
									 <?php 
					                    ...
					                    if($dt->status == "0"){
					                      echo "<span class='btn btn-danger disabled'>Telah di Sewa</span>";
					                    }else{
					                      echo anchor('customer/rental/tambah_rental/' . $dt->id_kos, '<button class="btn btn-success"> Sewa </button>');
					                    }
