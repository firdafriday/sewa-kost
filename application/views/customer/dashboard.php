                    ...
                    <div class="slideshowcontent">
                        <div class="display-table">
                            <div class="display-table-cell">
                                <h1>InfoKost</h1>
                                <p>SEWA KOST TERBAIK <br>HARGA BERSAHABAT, KUALITAS PALING MANTAP</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-funfact">
                                    ...
                                    <div class="funfact-content">
                                        <p><span class="counter"><?php echo $total_kos ?></span>+</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2>Pilih Kost Anda</h2>
                        <span class="title-line"><i class="fa fa-home"></i></span>
                        <p>Kost Pilihan Terbaik Untuk Memberikan Anda Kenyamanan</p>
                    </div>
                </div>
                <!-- Section Title End -->
            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 <?php echo $mb->kode_type ?>">
                                            <div class="single-popular-car">
                                                ...
                                                <div class="p-car-content">
                                                    <h3>
                                                        <a href="<?php echo base_url('customer/data_kos/detail_kos/') . $mb->id_kos ?>"><?php echo $mb->merk ?></a>
