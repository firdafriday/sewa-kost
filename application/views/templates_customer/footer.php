                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <p>InfoKost! Kami adalah penyedia jasa sewa kost terbaik dengan harga bersahabat dan kualitas paling mantap. Kami memiliki berbagai pilihan kost yang nyaman dan aman untuk Anda tinggali.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            <h2>Hubungi Kami</h2>
                            <div class="widget-body">
                                <p>Hubungi kami untuk mengetahui lebih banyak. Dapatkan layanan terbaik dan prioritas dari kami, InfoKost.</p>

                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Jl. ABC no 12, Jawa Barat</li>
                                    <li><i class="fa fa-mobile"></i> +62 811 1111 111</li>
                                    <li><i class="fa fa-envelope"></i> layanan@infokost.com</li>
                                </ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design by <a href="https://colorlib.com" target="_blank">Kelompok 8</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <div class="scroll-top">
        <img src="<?php echo base_url() ?>assets/assets_shop/img/scroll-top1.png" alt="JSOFT">
    </div>
    <!--== Scroll Top Area End ==-->
