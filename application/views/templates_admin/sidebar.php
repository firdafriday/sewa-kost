      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/data_kos") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_kos') ?>"><i class="fas fa-home"></i> <span>Data Kost</span></a></li>
